...
function submitCompose(newMail) {
    const mail = { id: utils.makeId(), ...newMail, isRead: false, sentAt: Date.now() }
    gMails.unshift(mail)
    console.log(gMails)
}
